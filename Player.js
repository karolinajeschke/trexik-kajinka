export default class Player {
  ...
  constructor(ctx,width,height,minJumpHeight,maxJumpHeight,scaleRatio){
    ...
    //Keyboard click - before i add them i have to have them disabled - so they can be triggered later on 
    ...
    //touch - before i add them i have to have them disabled - so they can be triggered later on 
  ...
  //then we implement those key methods
  keydown =(event)=> {
    if(event.code === "Space"){
